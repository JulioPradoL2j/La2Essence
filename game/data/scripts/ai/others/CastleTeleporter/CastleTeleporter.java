...
public class CastleTeleporter extends Script
{
	...
	private static Location getTeleportLocation(StatSet npcParams, String paramName1, String paramName2, String paramName3)
	{
		final Location loc;
		if (getRandom(100) < 33)
		{
	...
	private static String getHtmlName(Npc npc)
	{
		switch (npc.getId())
		{
			case 35092:
	...
	private static boolean isOwner(Player player, Npc npc)
	{
