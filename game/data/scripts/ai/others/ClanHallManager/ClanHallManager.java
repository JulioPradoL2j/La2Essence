...
public class ClanHallManager extends Script
{
	...
	private static void updateVisualEffects(ClanHall clanHall, Npc npc)
	{
		World.getInstance().forEachVisibleObject(npc, Player.class, player -> player.sendPacket(new AgitDecoInfo(clanHall)));
	}

	private static String getFunctionInfo(ResidenceFunction func, String htmltextValue, String name)
	{
	...
	private static boolean isOwningClan(Player player, Npc npc)
	{
