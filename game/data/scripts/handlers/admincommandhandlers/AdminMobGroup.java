...
public class AdminMobGroup implements IAdminCommandHandler
{
	...
	private static void returnToChar(String command, Player activeChar)
	{
		int groupId;
		try
		{
	...
	private static void idle(String command, Player activeChar)
	{
		int groupId;
	...
	private static void setNormal(String command, Player activeChar)
	{
		int groupId;
		try
		{
	...
	private static void attack(String command, Player activeChar, Creature target)
	{
		int groupId;
		try
		{
	...
	private static void follow(String command, Player activeChar, Creature target)
	{
		int groupId;
		try
		{
	...
	private static void createGroup(String command, Player activeChar)
	{
		int groupId;
		int templateId;
		int mobCount;
	...
	private static void removeGroup(String command, Player activeChar)
	{
		int groupId;
	...
	private static void spawnGroup(String command, Player activeChar)
	{
		int groupId;
		boolean topos = false;
		int posx = 0;
	...
	private static void unspawnGroup(String command, Player activeChar)
	{
		int groupId;
	...
	private static void killGroup(String command, Player activeChar)
	{
		int groupId;
	...
	private static void setCasting(String command, Player activeChar)
	{
		int groupId;
	...
	private static void noMove(String command, Player activeChar)
	{
		int groupId;
		String enabled;
	...
	private static void doAnimation(Player activeChar)
	{
	...
	private static void attackGrp(String command, Player activeChar)
	{
		int groupId;
		int othGroupId;
	...
	private static void invul(String command, Player activeChar)
	{
		int groupId;
		String enabled;
	...
	private static void teleportGroup(String command, Player activeChar)
	{
		int groupId;
	...
	private static void showGroupList(Player activeChar)
	{
