...
import net.sf.l2jdev.gameserver.network.serverpackets.AdminForgePacket;
...
public class AdminPForge implements IAdminCommandHandler
{
	...
	private static String[] getOpCodes(StringTokenizer st)
	{
	...
	private static boolean validateOpCodes(String[] opCodes)
	{
	...
	private static void showValuesUsage(Player activeChar)
	{
		activeChar.sendSysMessage("Usage: //forge_values opcode1[ opcode2[ opcode3]] ;[ format]");
		showMainPage(activeChar);
	}

	private static void showSendUsage(Player activeChar, String[] opCodes, String format)
	{
	...
	private static void showValuesPage(Player activeChar, String[] opCodes, String format)
	{
	...
	private static boolean write(byte b, String string, ByteBuffer buf)
	{
		if ((b == 'C') || (b == 'c'))
		{
