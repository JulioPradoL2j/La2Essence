...
// O Import deve estar correto conforme o caminho do seu projeto
...
public class Q10376_ExploringTheCrumaTowers2ndFloor5 extends Quest
{
	...
	private static final int NEXT_QUEST_ID = 19907;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					if (nextQuestState == null || (!nextQuestState.isStarted() && !nextQuestState.isCompleted()))
					{
						player.sendPacket(new ExQuestDialog(NEXT_QUEST_ID, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
