...
public class LimitShopClanData implements IXmlReader
{
	...
	public void load()
	{
		...
		this.parseDatapackFile("data/LimitShopClan.xml");
				...
				if (attribute != null && Boolean.parseBoolean(attribute.getNodeValue()))
				{
					for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
					{
						if ("product".equalsIgnoreCase(d.getNodeName()))
						{
							...
							this._products.add(new LimitShopProductHolder(id, category, minLevel, maxLevel, ingredientIds, ingredientQuantities, ingredientEnchants, productionId, 1L, 100.0F, false, 0, 0, 0L, 0.0F, false, 0, 0L, 0.0F, false, 0, 0L, 0.0F, false, 0, 0L, false, accountDailyLimit, accountWeeklyLimit, accountMonthlyLimit, accountBuyLimit));
						}
					}
				}
			}
	...
	{
		return LimitShopClanData.SingletonHolder.INSTANCE;
	}
